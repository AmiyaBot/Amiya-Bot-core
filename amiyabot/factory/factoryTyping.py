...
ReplyReturn = Awaitable[Optional[Union[Chain, list]]]
...
BeforeSendHandlerType = Callable[[Union[Chain, list], str, BotAdapterProtocol], ReplyReturn]
AfterSendHandlerType = Callable[[Union[Chain, list], str, BotAdapterProtocol], NoneReturn]
